...
export function LateIcon(props: IconProps) {
  return (
    <Svg {...props}>
...
export function OnLeaveIcon(props: IconProps) {
  return (
    <Svg {...props}>
...
export function EscalatedIcon(props: IconProps) {
  return (
    <Svg {...props}>
...
export function InboxIcon({ size = 30 }: IconProps) {
  return (
